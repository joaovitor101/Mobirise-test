                ...
                if (b >= a) {
                        ...
                        switch (true) {
                            ...
                            default:
                                if (2560 <= window.innerWidth) {
                                    translateX1 = c.m41 + 0.9 * (b - a);
                                } else if (1440 <= window.innerWidth) {
                    ...
                    if (d) {
                        ...
                        if (h.classList.contains("moving-left")) {
                            h.classList.contains("moving-left") && (8 > l && e(), 
                            2560 <= window.innerWidth ? c = d.m41 - 0.9 * (b - a) : 
                            1440 <= window.innerWidth ? c = d.m41 - 0.55 * (b - a) : 
                            1024 <= window.innerWidth ? c = d.m41 - 0.45 * (b - a) : 
                            768 <= window.innerWidth ? c = d.m41 - 0.35 * (b - a) : 
                            320 <= window.innerWidth && (c = d.m41 - 0.25 * (b - a)));
                        } else {
                            2560 <= window.innerWidth ? c = d.m41 + 0.9 * (b - a) : 
                            1440 <= window.innerWidth ? c = d.m41 + 0.55 * (b - a) : 
                            1024 <= window.innerWidth ? c = d.m41 + 0.45 * (b - a) : 
